...
.controller('TopMenuController', /*@ngInject*/ function TopMenuController($rootScope, $scope, $log, npm, npmGlobal, loadingFactory, errorsService) {
  ...
  this.updatePackage = currentSelectedPackages => {
      ...
      promiseSequence = promiseSequence.then(() => {
        return npmPromise.then(npmInFolder => {
          ...
          return npmInFolder.update(pkg).then(() => {
            ...
            errorsService.showErrorBox(`Error updating ${pkg.name}...`, error);
          });
        }).catch(error => {
          errorsService.showErrorBox(`Error preparing to update ${pkg.name}...`, error);
        });
      });
    });
    ...
    promiseSequence.then(() => {
      ...
      loadingFactory.finished();
      errorsService.showErrorBox('Error updating package.', error);
    });
  };
  ...
  this.installLatest = currentSelectedPackages => {
      ...
      promiseSequence = promiseSequence.then(() => {
        return npmPromise.then(npmInFolder => {
          ...
          return npmInFolder.installLatest(pkg).then(() => {
            ...
            errorsService.showErrorBox(`Error updating to latest ${pkg.name}...`, error);
          });
        }).catch(error => {
          errorsService.showErrorBox(`Error preparing to update to latest ${pkg.name}...`, error);
        });
      });
    });
    ...
    .catch(error => {
      loadingFactory.finished();
      errorsService.showErrorBox('Error updating to latest package version.', error);
    });
  ...
  this.uninstallPackage = currentSelectedPackages => {
      ...
      promiseSequence = promiseSequence.then(() => {
        return npmPromise.then(npmInFolder => {
          ...
          return npmInFolder.rm(pkg).then(() => {
            ...
            errorsService.showErrorBox(`Error uninstalling ${pkg.name}...`, error);
          });
        }).catch(error => {
          errorsService.showErrorBox(`Error preparing to uninstall ${pkg.name}...`, error);
        });
      });
    });
    ...
    promiseSequence.then(() => {
      ...
      loadingFactory.finished();
      errorsService.showErrorBox('Error uninstalling package.', error);
    });
  };
