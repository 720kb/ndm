...
.service('npm', /*@ngInject*/ function NpmService($rootScope, $log) {
  ...
  , getNpmInstalledAndAvailableVersion = () => new Promise(resolve => {
  ...
  this.getNpmInstalledAndAvailableVersion = getNpmInstalledAndAvailableVersion;
