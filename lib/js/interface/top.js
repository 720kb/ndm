...
.controller('TopMenuController', /*@ngInject*/ function TopMenuController($rootScope, $log, npm, npmGlobal, loadingFactory) {
  ...
  this.installPackage = (packageName, packageKind) => {
    ...
    npmPromise.catch(error => {
      ...
      dialog.showErrorBox(`Configuring npm for installing ${packageName}...`, error);
    })
    .then(npmInFolder =>
      npmInFolder.install({
        'name': packageName,
        ...
        loadingFactory.finished();
        dialog.showErrorBox(`Installing ${packageName}...`, error);
      }));
  };
  ...
  this.updatePackage = currentSelectedPackage => {
    ...
    npmPromise.catch(error => {
      loadingFactory.finished();
      dialog.showErrorBox(`Configuring npm for updating ${currentSelectedPackage.name}...`, error);
    }).then(npmInFolder =>
      ...
      .then(() => {
        ...
        loadingFactory.finished();
        dialog.showErrorBox(`Updating ${currentSelectedPackage.name}...`, error);
      }));
  };
  ...
  this.installLatest = currentSelectedPackage => {
    ...
    npmPromise.catch(error => {
      loadingFactory.finished();
      dialog.showErrorBox(`Configuring npm for installing latest ${currentSelectedPackage.name}...`, error);
    }).then(npmInFolder =>
      ...
      .catch(error => {
        loadingFactory.finished();
        dialog.showErrorBox(`Installing latest ${currentSelectedPackage.name}...`, error);
      }));
  };
  ...
  this.installVersionPackage = (currentSelectedPackage, specificVersion) => {
    ...
    npmPromise.catch(error => {
      loadingFactory.finished();
      dialog.showErrorBox(`Configuring npm for installing ${currentSelectedPackage.name}...`, error);
    }).then(npmInFolder =>
      ...
      .then(() => {
        ...
        loadingFactory.finished();
        dialog.showErrorBox(`Installing ${currentSelectedPackage.name}...`, error);
    }));
  };
  ...
  this.uninstallPackage = currentSelectedPackage => {
    ...
    npmPromise.catch(error => {
      loadingFactory.finished();
      dialog.showErrorBox(`Configuring npm for uninstalling ${currentSelectedPackage.name}...`, error);
    }).then(npmInFolder =>
      ...
      .then(() => {
        ...
        loadingFactory.finished();
        dialog.showErrorBox(`Uninstalling ${currentSelectedPackage.name}...`, error);
      }));
  };
