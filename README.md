...
`ndm` uses the [npm-cli](https://docs.npmjs.com/cli/npm) (```javascript require('npm')```) and packed up thanks to [Electron](https://github.com/electron/electron) with some touch of AngularJS and Sass.
