...
`ndm` is based on the [npm-cli](https://docs.npmjs.com/cli/npm) (`require('npm')`) and packed up thanks to [Electron](https://github.com/electron/electron) with some touch of AngularJS and Sass.
